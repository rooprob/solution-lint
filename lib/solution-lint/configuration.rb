class SolutionLint
  ...
  class Configuration
    ...
    # SolutionLint::Configuration object.
    #
    ...
    # Internal: Add options to the SolutionLint::Configuration object from inside
    # the class.
    #
    ...
    # Public: Add an option to the SolutionLint::Configuration object from
    # outside the class.
    #
    # option - The String name of the option.
    #
    ...
    # Public: Clear the SolutionLint::Configuration storage and set some sane
    # default values.
    #
    # Returns nothing.
    def defaults
